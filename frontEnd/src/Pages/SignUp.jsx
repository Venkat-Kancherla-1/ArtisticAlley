            ...
            <div className="w-1/2">
              ...
              <form onSubmit={handleFormSubmit} className="space-y-4"> 
                ...
                <div className="flex justify-center">
                  <button type="submit" className="bg-blue-500 text-white font-bold px-6 py-2 rounded-md hover:bg-blue-600">Sign Up <Link to="/home" className="underline text-blue-500"></Link></button> 
                </div>
              </form>
            </div>
